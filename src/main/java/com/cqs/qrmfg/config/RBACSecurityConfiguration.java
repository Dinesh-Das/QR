...
public class RBACSecurityConfiguration {
    ...
    private void initializeDefaults() {
        ...
        roleUrlPatterns.put(RoleType.JVC_ROLE.getRoleName(), Arrays.asList("/qrmfg/api/v1/jvc/**", "/qrmfg/api/v1/workflows/**", "/qrmfg/api/v1/queries/**", "/qrmfg/api/v1/projects/**", "/qrmfg/api/v1/test-analytics/**", "/api/v1/test-analytics/**"));
        roleUrlPatterns.put(RoleType.CQS_ROLE.getRoleName(), Arrays.asList("/qrmfg/api/v1/cqs/**", "/qrmfg/api/v1/quality/**", "/qrmfg/api/v1/workflows/**", "/qrmfg/api/v1/queries/**", "/qrmfg/api/v1/test-analytics/**", "/api/v1/test-analytics/**"));
        roleUrlPatterns.put(RoleType.TECH_ROLE.getRoleName(), Arrays.asList("/qrmfg/api/v1/tech/**", "/qrmfg/api/v1/admin/users/**", "/qrmfg/api/v1/admin/audit/**", "/qrmfg/api/v1/queries/**", "/qrmfg/api/v1/test-analytics/**", "/api/v1/test-analytics/**"));
